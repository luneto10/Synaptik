...
function TableNodeColumnRow({
    ...
    const availableTypes = getDiagramDialect(dialect).types;
    const {
        nameInputRef,
        editing,
        draftName,
    ...
    return (
        <div
            className={cn(
                "group relative flex items-center overflow-hidden border-b border-border/30 last:border-0 hover:bg-muted/40 transition-colors border-l-2",
        ...
        >
            ...
            <div className="flex-1 px-1 py-1.5 min-w-0">
                {editing ? (
                    ...
                    <Button
                        ...
                        className="nodrag nopan h-7 w-full justify-start rounded px-0 text-sm font-mono text-foreground hover:bg-transparent select-none"
                    >
            ...
            <div className="w-14 px-1 shrink-0">
                <div className="flex items-center justify-end gap-0.5 opacity-45 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    className="nodrag nopan h-5 w-5 shrink-0 text-muted-foreground hover:text-destructive hover:bg-destructive/10"
                                >
